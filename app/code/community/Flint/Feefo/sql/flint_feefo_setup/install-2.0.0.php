 ...
 */
$this->removeAttribute('catalog_product', 'feefo_disable_feeds');
...
$this->removeAttribute('catalog_product', 'feefo_disable_frontend');
...
$this->removeAttribute('catalog_product', 'feefo_business_category');
