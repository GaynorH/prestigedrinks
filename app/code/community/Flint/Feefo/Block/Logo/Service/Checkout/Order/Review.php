...
?>
<?php
class Flint_Feefo_Block_Logo_Service_Checkout_Order_Review extends Flint_Feefo_Block_Logo_Service_Abstract
{

    public function getLogoTemplate() {
        return $this->getConfigService()->getLogoTemplateCheckoutReview();
    }

    public function getCssId() {
        return 'feefo_logo_checkout_review';
    }
