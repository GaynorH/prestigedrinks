...
?>
<?php
class Flint_Feefo_Block_Logo_Product_Category_List extends Flint_Feefo_Block_Logo_Product_Abstract
{

    public function getLogoTemplate() {
        return $this->getConfigProduct()->getLogoTemplateCatalog();
    }
    ...
    public function getCssId() {
        return 'flint_feefo_product_list';
    }
