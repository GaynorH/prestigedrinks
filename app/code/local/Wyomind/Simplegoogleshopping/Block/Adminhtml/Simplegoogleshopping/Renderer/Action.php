        ...
        $this->getColumn()->setActions(
                array(
                    ...
                    array(
                     ...
                     array(
                        'url' => $this->getUrl('*/adminhtml_simplegoogleshopping/showReport', array('simplegoogleshopping_id' => $row->getSimplegoogleshoppingId())),
                        'caption' => Mage::helper('simplegoogleshopping')->__('Show report') ,
                        'popup' => true
                    ),
                    array(
                        'url' => $this->getUrl('*/adminhtml_simplegoogleshopping/delete', array('id' => $row->getSimplegoogleshoppingId())),
                        'confirm' => Mage::helper('simplegoogleshopping')->__('Are you sure you want to delete this feed ?'),
